...
type SessionEntity struct {
	BaseEntity
	SessionId  uuid.UUID `json:"session_id" gorm:"primaryKey;uniqueIndex;not null;size:36;type:uuid;default:uuid_generate_v4()"`
	UserId     uuid.UUID `json:"user_id" gorm:"not null;index;size:36"`
